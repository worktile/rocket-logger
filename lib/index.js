...
const lodash_iserror_1 = require("lodash.iserror");
const lodash_isstring_1 = require("lodash.isstring");
const _ = {
    isObject: lodash_isobject_1.default,
    isError: lodash_iserror_1.default,
    isString: lodash_isstring_1.default
};
